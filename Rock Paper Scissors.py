...
Label(text = 'The Game of', font = font.Font(size = 20),fg='white', bg = 'black').pack()
Label(text = 'ROCK PAPER SCISSORS', font = font.Font(size = 20),fg='white', bg = 'black').pack()
...
def player_choice(player_input):
    ...
    player_choice_label.config(text = 'Selected by You : ' + player_input[0])
    computer_choice_label.config(text = 'Played by computer : ' + computer_input[0])

    if player_input == computer_input:
        winner_label.config(text = "DRAWWW XD")
    elif (player_input[1]-computer_input[1]) % 3 == 1:
        player_score += 1
        winner_label.config(text="You Won <3")
...
winner_label = Label(text = "Let's Start the Game...", fg = '#7FFFD4', bg = 'black', font = font.Font(size = 13), pady = 8)
winner_label.pack()
...
paper_btn = Button(input_frame, text = 'Paper', width = 15, bd = 0, bg = '#E3CF57', pady = 5, command = lambda: player_choice(options[1]))
...
player_choice_label = Label(input_frame, text = 'Selected by you : ---', font = app_font,fg='white', bg = 'black')
...
computer_choice_label = Label(input_frame, text = 'Played by Computer : ---', font = app_font, fg = 'white', bg = 'black')
